...
# ============================================================
# دوال مساعدة للبحث/إنشاء البلدية والعيادة
# ============================================================
...
def get_or_create_clinic(name, wilaya_id, commune_id=None):
    """ابحث عن عيادة أو أنشئها إذا لم تكن موجودة"""
    if not name or not name.strip():
        return None
